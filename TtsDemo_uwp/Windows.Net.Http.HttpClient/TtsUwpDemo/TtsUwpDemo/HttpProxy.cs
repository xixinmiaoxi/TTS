    ...
    public class HttpProxy
    {
        ...
        public static async void sendRequest(String url, String body, String ak_id, String ak_secret)
        {
            ...
            try
            {
                ...
                httpWebRequest.Headers["Method"] = method;
                ...
                httpWebRequest.Headers["ContentType"] = content_type;
                httpWebRequest.Headers["Content-Length"] = encodingGbk.GetBytes(body).Length.ToString();
