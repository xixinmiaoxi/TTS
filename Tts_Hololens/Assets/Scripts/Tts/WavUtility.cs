...
//        // riff chunk id
//        byte[] riff = Encoding.Unicode.GetBytes("RIFF");
...
//        byte[] wave = Encoding.Unicode.GetBytes("WAVE");
...
//        byte[] id = Encoding.Unicode.GetBytes("fmt ");
...
//        byte[] id = Encoding.Unicode.GetBytes("data");
